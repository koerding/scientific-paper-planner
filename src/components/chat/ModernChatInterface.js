                  ...
                  <div className="space-y-4">
                    ...
                    {safeChatMessages.map((msg, idx) => (
                      <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                        ...
                        <div
                          className={`message-bubble rounded-lg p-3 max-w-[80%] ${ msg.role === 'user' ? 'bg-indigo-600 text-white self-end' : 'bg-white border border-gray-200 text-gray-800 self-start' }`}
