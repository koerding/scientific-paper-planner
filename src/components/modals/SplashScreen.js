        ...
        <div className="px-4 py-3 overflow-y-auto">
          ...
          <div className="bg-gray-100 border border-gray-300 rounded-lg p-3 mb-4">
            ...
            <p className="text-sm text-gray-700 font-bold mt-2">
              This app guides you through the steps of planning your research. This is key to successfully publishing your papers. Spending 10 hours on this is not a waste. Start by editing the question. And then section by section.
            </p>
          </div>
