...
// Render function for original instructions
...
// Render function for improved instructions
...
const FullHeightInstructionsPanel = ({ activeSectionId, improveInstructions, loading }) => {
  ...
  const toggleTooltip = useCallback((id) => { // Use useCallback
