...
// UPDATED: Removed text from Write mode buttons, icon only + fixed syntax error
...
const FullHeightInstructionsPanel = ({ 
  ...
  return (
    ...
    <div className="w-full h-full overflow-y-auto pb-20 box-border flex-shrink-0 bg-gray-50 relative">
      {/* No separate top navigation needed since it's now in the header */}
      ...
      {/* Bottom Write Mode Icon Only Button */}
      {onRequestWrite && (
