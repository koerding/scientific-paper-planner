  ...
  return (
    <div className="bg-gray-100 p-1 rounded-full inline-flex items-center justify-center shadow-sm">
      <button
        ...
        className={`flex items-center justify-center px-5 py-1.5 rounded-full text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
          currentMode === 'write'
      ...
      <span className="text-gray-400 mx-1.5 flex items-center">·</span>
