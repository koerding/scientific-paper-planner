  ...
  return (
    <div className="bg-gray-100 p-2 rounded-full inline-flex items-center justify-center shadow-sm">
      <button
        ...
        className={`flex items-center justify-center px-5 py-2 rounded-full text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
          currentMode === 'write'
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" style={{height: '0.5rem', width: '0.75rem', marginRight: '0.25rem'}} fill="none" viewBox="0 0 24 24" stroke="currentColor">
