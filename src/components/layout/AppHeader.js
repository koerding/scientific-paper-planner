...
const AppHeader = ({
  ...
  const handleFileChange = (event) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        else alert("Loading functionality is not available");
      } catch (error) {
  ...
  const handleExamplesClick = () => {
    if (typeof setShowExamplesDialog === 'function') setShowExamplesDialog(true);
    else console.error("setShowExamplesDialog function is not provided to AppHeader");
  };
