        ...
        {!chatMessages[currentSection] || chatMessages[currentSection].length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center p-6">
            ...
            <p className="text-gray-500 max-w-md">
              I'll help you develop your research project. Click "Mark First Version Complete" above 
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center">
          <input
            ...
            placeholder="Ask a question about your research design..."
        ...
        <div className="mt-2 text-xs text-gray-500 flex items-center">
          ...
          <span>Ask about methodology, literature recommendations, or feedback on your current section</span>
        </div>
      </div>
    </div>
  );
