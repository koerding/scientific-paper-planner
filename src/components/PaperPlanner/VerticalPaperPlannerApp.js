 ...
 * UPDATED: Added examples feature and simplified load functionality
 */
const PaperPlannerApp = () => {
  ...
  // Function to show examples dialog
  const showExamples = () => {
    console.log("Showing examples dialog");
    setShowExamplesDialog(true);
  };

  // Function to load project from imported JSON file or example
