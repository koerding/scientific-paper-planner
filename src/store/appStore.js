...
const useAppStore = create(
  persist( // Persist state to localStorage
    (set, get) => ({
      ...
      // --- Added Unified Loading States ---
      loadingStates: {
        chat: false,       // Chat message sending
        review: false,     // Paper review processing
        import: false,     // Document import processing
        feedback: false,   // Section feedback generation
      },

      // --- Actions ---
      // Set loading state for any AI operation
      ...
      resetState: () => set({
        ...
        scores: {},
        proMode: false,
        loadingStates: { chat: false, review: false, import: false, feedback: false },
      }),
    ...
    }),
    {
      ...
      partialize: (state) => ({
         ...
         // Note: We don't persist loadingStates - should always start as false
      }),
